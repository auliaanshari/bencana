...
$bulan = $_GET['bulan'];
$tahun = $_GET['tahun'];
        $querysearch= "SELECT distinct tanggal_kejadian, nama_bahaya, nama_kecamatan, ST_X(ST_Centroid(kecamatan.geom)) AS longitude, ST_Y(ST_CENTROID(kecamatan.geom)) As latitude
		...
		where date_part('month',tanggal_kejadian) = '$bulan' and date_part('year',tanggal_kejadian) = '$tahun'";
